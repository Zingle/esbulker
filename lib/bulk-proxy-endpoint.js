...
class BulkProxyEndpoint extends EventEmitter {
    ...
    /**
     * Queue a document to for bulk loading.  Return true if the document id is
     * new to the queue.  Return false if an existing queued document was
     * overwritten.
     * @param {string} id
     * @param {object} doc
     * @param {string} [parent]
    ...
    put(id, doc, parent) {
        ...
        // let caller know if doc was created or overwritten
        return created;
    }
