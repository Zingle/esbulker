...
class BulkProxy extends EventEmitter {
    ...
    *endpoints() {
    ...
    /**
     * Queue a document for loading.  Return true if the document id is new to
     * the queue.  Return false if an existing queued document was overwritten.
     * @param {string} index
     * @param {string} doctype
     * @param {string} id
     * @param {object} doc
    ...
    put(index, doctype, id, doc, parent) {
        ...
        const created = endpoint.put(id, doc, parent);
